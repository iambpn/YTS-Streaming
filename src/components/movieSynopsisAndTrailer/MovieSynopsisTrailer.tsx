...
interface MovieSynopsisTrailerProps {
  title: string;
  screenshot: string;
...
export default function MovieSynopsisTrailer(props: MovieSynopsisTrailerProps) {
  const handleOpenTrailer = () => {
    ...
    window.api.send(
      'ExternalLink:Open',
      'https://www.youtube.com/watch?v=' + props.yt_trailer_code
    );
  };
  ...
  return (
    <div className="row mt-5 mb-4 justify-content-center">
      <div className="col-6">
        <h3 style={{ fontSize: '1.25em' }} className="fw-bolder">
          Synopsis
        </h3>
        <p
          className="text-wrap fw-lighter"
      ...
      <div className="col-6 text-center" style={{ height: 'max-content' }}>
        <h3 style={{ fontSize: '1.25em' }} className="fw-bolder mb-4">
          Watch Trailer :
        </h3>
        <div
          className="trailer"
